namespace memoriza_backend.Models.Auth
{
    public class User
    {
        // PK
        ...
        // 🔹 NOVO: último login (local ou Google)
        public DateTime? LastLoginAt { get; set; }

        // 🔹 NOVO: Grupo de usuário (1 = comum, 2 = admin)
        ...
        // 🔹 NOVO: origem da conta
        // "Local"  -> criada por e-mail/senha
        // "Google" -> criada via OAuth do Google
        public string AuthProvider { get; set; } = "Local";

        // Para contas Google
        public string? ProviderUserId { get; set; }  // sub do Google
