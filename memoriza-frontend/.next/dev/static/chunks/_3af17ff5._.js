...
function PedidosPage() {
    ...
    const filteredOrders = userOrders.filter((order)=>order.id.toLowerCase().includes(searchTerm.toLowerCase()) || order.items.some((item)=>item.produtoNome.toLowerCase().includes(searchTerm.toLowerCase())));
...
_s(PedidosPage, "up51pbOQ7ntQX8RKZa+FwJ5/WAQ=", false, function() {
    return [
...
//# sourceMappingURL=_3af17ff5._.js.map