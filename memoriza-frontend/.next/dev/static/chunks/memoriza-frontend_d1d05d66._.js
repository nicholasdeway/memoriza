...
function ProductDetailPage({ params }) {
    ...
    const { addItem } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$lib$2f$cart$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
    ...
    const [product, setProduct] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [selectedImageIndex, setSelectedImageIndex] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    // estados de customização
    const [selectedColorId, setSelectedColorId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [selectedSizeId, setSelectedSizeId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [personalizationText, setPersonalizationText] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const [isAdding, setIsAdding] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProductDetailPage.useEffect": ()=>{
            const loadProduct = {
                "ProductDetailPage.useEffect.loadProduct": async ()=>{
                    try {
                        setLoading(true);
                        ...
                        const categoriaNome = categories.find({
                            "ProductDetailPage.useEffect.loadProduct": (c)=>c.id === prodJson.categoryId
                        }["ProductDetailPage.useEffect.loadProduct"])?.name ?? "";
                        const tamanhos = (prodJson.sizeIds ?? []).map({
                            "ProductDetailPage.useEffect.loadProduct.tamanhos": (sizeId)=>{
                                const s = sizesApi.find({
                                    "ProductDetailPage.useEffect.loadProduct.tamanhos.s": (x)=>x.id === sizeId && x.isActive
                                }["ProductDetailPage.useEffect.loadProduct.tamanhos.s"]);
                                return s ? {
                                    id: s.id,
                                    nome: s.name
                                } : null;
                            }
                        }["ProductDetailPage.useEffect.loadProduct.tamanhos"]).filter({
                            "ProductDetailPage.useEffect.loadProduct.tamanhos": (x)=>x !== null
                        }["ProductDetailPage.useEffect.loadProduct.tamanhos"]);
                        const cores = (prodJson.colorIds ?? []).map({
                            "ProductDetailPage.useEffect.loadProduct.cores": (colorId)=>{
                                const c = colorsApi.find({
                                    "ProductDetailPage.useEffect.loadProduct.cores.c": (x)=>x.id === colorId && x.isActive
                                }["ProductDetailPage.useEffect.loadProduct.cores.c"]);
                                return c ? {
                                    id: c.id,
                                    nome: c.name,
                                    codigoHex: c.hexCode
                        ...
                        }["ProductDetailPage.useEffect.loadProduct.cores"]).filter({
                            "ProductDetailPage.useEffect.loadProduct.cores": (x)=>x !== null
                        }["ProductDetailPage.useEffect.loadProduct.cores"]);
                        const imagensOrdenadas = (prodJson.images ?? []).slice().sort({
                            "ProductDetailPage.useEffect.loadProduct.imagensOrdenadas": (a, b)=>{
                                if (a.isPrimary !== b.isPrimary) return a.isPrimary ? -1 : 1;
                                return a.displayOrder - b.displayOrder;
                            }
                        }["ProductDetailPage.useEffect.loadProduct.imagensOrdenadas"]);
                        const mapped = {
                            id: prodJson.id,
                            nome: prodJson.name,
    ...
    const handleAddToCart = ()=>{
        if (!product) return;
        if (!user) {
            __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].info("Faça login para adicionar produtos ao carrinho.");
        ...
        if (hasErrors) {
            __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Preencha as opções obrigatórias antes de adicionar ao carrinho.");
            return;
        }
        try {
            setIsAdding(true);
            ...
            setTimeout(()=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Produto adicionado ao carrinho!", {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Não foi possível adicionar o produto ao carrinho.");
        } finally{
            setIsAdding(false);
        }
    };
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    imagens.length > 1 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "grid grid-cols-4 gap-4",
                                        children: imagens.slice(0, 4).map((img, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                type: "button",
                                ...
                                children: [
                                    ...
                                    product.personalizavel ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            product.cores.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    ...
                                                    errors.color && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            product.tamanhos.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                        className: "block text-sm font-medium text-foreground mb-2",
                                                        children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                        ...
                                                        children: [
                                                            ...
                                                            product.tamanhos.map((t)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                                    value: t.id,
                                                                    children: t.nome
                                                                }, t.id, false, {
                                                                    fileName: "[project]/memoriza-frontend/app/products/[id]/page.tsx",
                                                    ...
                                                    errors.size && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        className: "mt-1 text-xs text-red-500",
...
_s(ProductDetailPage, "nFXLC+S2arfRPyG+w4l6nz0KY94=", false, function() {
    return [
...
//# sourceMappingURL=memoriza-frontend_d1d05d66._.js.map