...
function ProductsPage() {
                ...
                "ProductsPage.useEffect.fetchData": async ()=>{
                    try {
                        ...
                        if (catRes.ok) {
                            ...
                            const mapped = data.filter({
                                "ProductsPage.useEffect.fetchData.mapped": (c)=>c.isActive
                            }["ProductsPage.useEffect.fetchData.mapped"]).sort({
                                "ProductsPage.useEffect.fetchData.mapped": (a, b)=>new Date(a.createdAt).getTime() - new Date(b.createdAt).getTime()
                            }["ProductsPage.useEffect.fetchData.mapped"]).map({
                                "ProductsPage.useEffect.fetchData.mapped": (c)=>({
                                        id: c.id,
                                        name: c.name
                                    })
                            }["ProductsPage.useEffect.fetchData.mapped"]);
                            setCategories(mapped);
                        }
                        // Tamanhos
                        if (sizeRes.ok) {
                            ...
                            const mappedSizes = data.filter({
                                "ProductsPage.useEffect.fetchData.mappedSizes": (s)=>s.isActive
                            }["ProductsPage.useEffect.fetchData.mappedSizes"]).map({
                                "ProductsPage.useEffect.fetchData.mappedSizes": (s)=>({
                                        id: s.id,
                                        name: s.name
                                    })
                            }["ProductsPage.useEffect.fetchData.mappedSizes"]);
                        ...
                        if (colorRes.ok) {
                            ...
                            const mappedColors = data.filter({
                                "ProductsPage.useEffect.fetchData.mappedColors": (c)=>c.isActive
                            }["ProductsPage.useEffect.fetchData.mappedColors"]).map({
                                "ProductsPage.useEffect.fetchData.mappedColors": (c)=>({
                                        id: c.id,
                                        name: c.name,
                                        hex: c.hexCode
                                    })
                            }["ProductsPage.useEffect.fetchData.mappedColors"]);
                        ...
                        if (productRes.ok) {
                            ...
                            const mappedProducts = data.filter({
                                "ProductsPage.useEffect.fetchData.mappedProducts": (p)=>p.isActive
                            }["ProductsPage.useEffect.fetchData.mappedProducts"]).map({
                                "ProductsPage.useEffect.fetchData.mappedProducts": (p)=>{
                                    const primaryImage = p.images.find({
                                        "ProductsPage.useEffect.fetchData.mappedProducts": (img)=>img.isPrimary
                                    }["ProductsPage.useEffect.fetchData.mappedProducts"]) ?? p.images[0];
                                    return {
                                        id: p.id,
                            ...
                            }["ProductsPage.useEffect.fetchData.mappedProducts"]);
    ...
    const sizeCounts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProductsPage.useMemo[sizeCounts]": ()=>{
            const counts = {};
            products.forEach({
                "ProductsPage.useMemo[sizeCounts]": (p)=>{
                    p.sizeIds.forEach({
                        "ProductsPage.useMemo[sizeCounts]": (id)=>{
    ...
    const colorCounts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProductsPage.useMemo[colorCounts]": ()=>{
            const counts = {};
            products.forEach({
                "ProductsPage.useMemo[colorCounts]": (p)=>{
                    p.colorIds.forEach({
                        "ProductsPage.useMemo[colorCounts]": (id)=>{
                            counts[id] = (counts[id] || 0) + 1;
                        }
                    }["ProductsPage.useMemo[colorCounts]"]);
                }
    ...
    const filteredProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProductsPage.useMemo[filteredProducts]": ()=>{
            let list = products.filter({
                "ProductsPage.useMemo[filteredProducts].list": (p)=>{
                    // Categoria
                    ...
                    const matchSize = selectedSizeIds.length === 0 || p.sizeIds.some({
                        "ProductsPage.useMemo[filteredProducts].list": (id)=>selectedSizeIds.includes(id)
                    }["ProductsPage.useMemo[filteredProducts].list"]);
                    // Cor
                    const matchColor = selectedColorIds.length === 0 || p.colorIds.some({
                        "ProductsPage.useMemo[filteredProducts].list": (id)=>selectedColorIds.includes(id)
                    }["ProductsPage.useMemo[filteredProducts].list"]);
                    // Preço
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: filteredProducts.map((product)=>{
                                                    ...
                                                    const basePrice = product.price;
                                                    const finalPrice = product.promotionalPrice && product.promotionalPrice > 0 ? product.promotionalPrice : basePrice;
                                                    const hasDiscount = product.promotionalPrice && product.promotionalPrice > 0 && product.promotionalPrice < basePrice;
                                                    ...
                                                    const productColors = product.colorIds.map((id)=>colors.find((c)=>c.id === id)).filter((c)=>Boolean(c));
                                                    return(// CARD NO ESTILO KABUM
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "group flex flex-col h-full bg-muted/30 rounded-xl border border-border/50 hover:shadow-md transition-all p-2",
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                                ...
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        className: "relative w-full h-52 md:h-56 bg-muted rounded-lg overflow-hidden mb-3",
                                                                        children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                                                        className: "font-medium text-foreground group-hover:text-accent transition-colors line-clamp-2 min-h-[2.75rem]",
                                                                    ...
                                                                    productColors.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        children: productColors.map((color)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                className: "w-4 h-4 rounded-full border border-border",
                                                                                style: {
                                                                                    backgroundColor: color.hex || "#ffffff"
                                                                                }
                                                                    ...
                                                                    sizeLabel && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        }, void 0, true) : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$memoriza$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                            className: "font-medium text-foreground",
                                                                            children: formatCurrency(basePrice)
                                                                        }, void 0, false, {
                                                                            fileName: "[project]/memoriza-frontend/app/products/page.tsx",
...
_s(ProductsPage, "O56Ok1GE/8lYr+oRKvYgvsqlXRg=");
_c = ProductsPage;
var _c;
...
//# sourceMappingURL=memoriza-frontend_29a2f621._.js.map